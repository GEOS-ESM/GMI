...
!....           O + O = O2
!
      rcarr(1,:) = skoo (temperature ,adcol)
!
!....           O + O2 = O3
!
      rcarr(2,:) = skterlp(  6.000D-34 ,2.40D+00 ,0.0D0 &
     &                     ,temperature ,adcol)
!
!....           O + O3 = 2 O2
!
      rcarr(3,:) = skarr(  8.000D-12 ,2060.0D+00 ,temperature)
!
!....           H2O2 + O = HO2 + OH
!
      rcarr(4,:) = skarr(  1.400D-12 ,2000.0D+00 ,temperature)
!
!....           N2 + O1D = N2 + O
!
      rcarr(5,:) = skarr(  2.150D-11 ,-110.0D+00 ,temperature)
!
!....           O1D + O2 = O + O2
!
      rcarr(6,:) = skarr(  3.300D-11 ,-55.0D+00 ,temperature)
!
!....           O1D + O3 = 2 O2
!
      rcarr(7,:) = skarr(  1.200D-10 ,0.0D+00 ,temperature)
!
!....           O1D + O3 = 2 O + O2
!
...
!....           H2O + O1D = 2 OH
!
      rcarr(9,:) = skarr(  1.630D-10 ,-60.0D+00 ,temperature)
!
!....           H2 + O1D = H + OH
!
      rcarr(10,:) = skarr(  1.200D-10 ,0.0D+00 ,temperature)
!
!....           N2O + O1D = N2 + O2
!
      rcarr(11,:) = skarr(  4.640D-11 ,-20.0D+00 ,temperature)
!
!....           N2O + O1D = 2 NO
!
      rcarr(12,:) = skarr(  7.260D-11 ,-20.0D+00 ,temperature)
!
!....           CH4 + O1D = MO2 + OH
!
      rcarr(13,:) = skarr(  1.310D-10 ,0.0D+00 ,temperature)
!
!....           CH4 + O1D = CH2O + H + HO2
!
      rcarr(14,:) = skarr(  3.500D-11 ,0.0D+00 ,temperature)
!
!....           CH4 + O1D = CH2O + H2
!
      rcarr(15,:) = skarr(  8.750D-12 ,0.0D+00 ,temperature)
!
!....           CFC12 + O1D = 2 Cl
!
      rcarr(16,:) = skarr(  1.400D-10 ,-25.0D+00 ,temperature)
!
!....           CFC113 + O1D = 3 Cl
!
      rcarr(17,:) = skarr(  2.320D-10 ,0.0D+00 ,temperature)
!
!....           CFC114 + O1D = 2 Cl
!
      rcarr(18,:) = skarr(  1.300D-10 ,-25.0D+00 ,temperature)
!
!....           CFC115 + O1D = Cl
!
      rcarr(19,:) = skarr(  5.400D-11 ,-30.0D+00 ,temperature)
!
!....           HCFC22 + O1D = Cl
!
      rcarr(20,:) = skarr(  1.020D-10 ,0.0D+00 ,temperature)
!
!....           HCFC141b + O1D = 2 Cl
!
      rcarr(21,:) = skarr(  2.600D-10 ,0.0D+00 ,temperature)
!
!....           HCFC142b + O1D = Cl
!
      rcarr(22,:) = skarr(  2.000D-10 ,0.0D+00 ,temperature)
!
!....           H + O2 = HO2
!
      rcarr(23,:) = sktroe(  5.300D-32 ,1.80D0 & 
     &                     , 9.500D-11 ,-0.40D0 ,0.0D0 &
     &                     ,temperature ,adcol)
!
!....           H + O3 = O2 + OH
!
      rcarr(24,:) = skarr(  1.400D-10 ,470.0D+00 ,temperature)
!
!....           H + HO2 = 2 OH
!
...
!....           H + HO2 = H2 + O2
!
      rcarr(26,:) = skarr(  6.900D-12 ,0.0D+00 ,temperature)
!
!....           H + HO2 = H2O + O
!
      rcarr(27,:) = skarr(  1.600D-12 ,0.0D+00 ,temperature)
!
!....           H + NO2 = NO + OH
!
      rcarr(28,:) = skarr(  1.350D-10 ,0.0D+00 ,temperature)
!
!....           O + OH = H + O2
!
      rcarr(29,:) = skarr(  1.800D-11 ,-180.0D+00 ,temperature)
!
!....           HO2 + O = O2 + OH
!
      rcarr(30,:) = skarr(  3.000D-11 ,-200.0D+00 ,temperature)
!
!....           H + HO2 = 2 OH
!
      rcarr(31,:) = skarr(  7.200D-11 ,0.0D+00 ,temperature)
!
!....           O3 + OH = HO2 + O2
!
      rcarr(32,:) = skarr(  1.700D-12 ,940.0D+00 ,temperature)
!
!....           HO2 + O3 = 2 O2 + OH
!
      rcarr(33,:) = skarr(  1.000D-14 ,490.0D+00 ,temperature)
!
!....           OH + OH = H2O + O
!
      rcarr(34,:) = skarr(  1.800D-12 ,0.0D+00 ,temperature)
!
!....           OH + OH = H2O2
!
      rcarr(35,:) = sktroe(  6.900D-31 ,1.00D0 & 
     &                     , 2.600D-11 ,0.00D0 ,0.0D0 &
     &                     ,temperature ,adcol)
!
!....           HO2 + OH = H2O + O2
!
      rcarr(36,:) = skarr(  4.800D-11 ,-250.0D+00 ,temperature)
!
!....           H2O2 + OH = H2O + HO2
!
      rcarr(37,:) = skarr(  1.800D-12 ,0.0D+00 ,temperature)
!
!....           HO2 + HO2 = H2O2 + O2
!
      rcarr(38,:) = skho2dis (temperature ,adcol)
!
!....           H2O + HO2 + HO2 = H2O + H2O2 + O2
!
      rcarr(39,:) = skho2h2o (temperature ,adcol)
!
!....           H2 + OH = H + H2O
!
      rcarr(40,:) = skarr(  2.800D-12 ,1800.0D+00 ,temperature)
!
!....           NO + O3 = NO2 + O2
!
      rcarr(41,:) = skarr(  3.000D-12 ,1500.0D+00 ,temperature)
!
!....           NO2 + O3 = NO3 + O2
!
      rcarr(42,:) = skarr(  1.200D-13 ,2450.0D+00 ,temperature)
!
!....           HO2 + NO = NO2 + OH
!
      rcarr(43,:) = skarr(  3.440D-12 ,-260.0D+00 ,temperature)
!
!....           CO + OH = H
!
      rcarr(44,:) = skohco (temperature ,adcol)
!
!....           CH4 + OH = H2O + MO2
!
      rcarr(45,:) = skohch4 (temperature)
!
!....           MO2 + NO = CH2O + HO2 + NO2
!
      rcarr(46,:) = skarr(  2.800D-12 ,-300.0D+00 ,temperature)
!
!....           ClO + MO2 = CH2O + Cl + HO2 + O2
!
      rcarr(47,:) = skarr(  1.800D-11 ,600.0D+00 ,temperature)
!
!....           HO2 + MO2 = MP + O2
!
      rcarr(48,:) = skarr(  4.100D-13 ,-750.0D+00 ,temperature)
!
!....           MO2 + MO2 = CH2O + MOH + O2
!
      rcarr(49,:) = skmo2dis_1 (temperature)
!
!....           MO2 + MO2 = 2 CH2O + 2 HO2
!
      rcarr(50,:) = skmo2dis_2 (temperature)
!
!....           MP + OH = H2O + MO2
!
      rcarr(51,:) = skarr(  2.660D-12 ,-200.0D+00 ,temperature)
!
!....           MP + OH = CH2O + H2O + OH
!
      rcarr(52,:) = skarr(  1.140D-12 ,-200.0D+00 ,temperature)
!
!....           CH2O + OH = CO + H2O + HO2
!
      rcarr(53,:) = skarr(  5.500D-12 ,-125.0D+00 ,temperature)
!
!....           NO + O = NO2
!
      rcarr(54,:) = sktroe(  9.100D-32 ,1.50D0 & 
     &                     , 3.000D-11 ,0.00D0 ,0.0D0 &
     &                     ,temperature ,adcol)
!
!....           NO2 + O = NO + O2
!
      rcarr(55,:) = skono2_d (temperature ,adcol)
!
!....           NO2 + O = NO3
!
      rcarr(56,:) = skono2_a (temperature ,adcol)
!
!....           NO3 + O = NO2 + O2
!
      rcarr(57,:) = skarr(  1.300D-11 ,0.0D+00 ,temperature)
!
!....           N + O2 = NO + O
!
      rcarr(58,:) = skarr(  3.300D-12 ,3150.0D+00 ,temperature)
!
!....           N + OH = H + NO
!
      rcarr(59,:) = skarr(  5.000D-11 ,0.0D+00 ,temperature)
!
!....           N + NO = N2 + O
!
      rcarr(60,:) = skarr(  2.100D-11 ,-100.0D+00 ,temperature)
!
!....           N + NO2 = N2O + O
!
      rcarr(61,:) = skarr(  5.800D-12 ,-220.0D+00 ,temperature)
!
!....           NO2 + OH = HNO3
!
      rcarr(62,:) = sktroe(  1.800D-30 ,3.00D0 & 
     &                     , 2.800D-11 ,0.00D0 ,0.0D0 &
     &                     ,temperature ,adcol)
!
!....           HNO3 + OH = H2O + NO3
!
      rcarr(63,:) = skohhno3_j19 (temperature ,adcol)
!
!....           NO + OH = HNO2
!
      rcarr(64,:) = sktroe(  7.100D-31 ,2.60D0 & 
     &                     , 3.600D-11 ,0.10D0 ,0.0D0 &
     &                     ,temperature ,adcol)
!
!....           HNO2 + OH = H2O + NO2
!
      rcarr(65,:) = skarr(  3.000D-12 ,-250.0D+00 ,temperature)
!
!....           HO2 + NO2 = HNO4
!
      rcarr(66,:) = sktroe(  1.900D-31 ,3.40D0 & 
     &                     , 4.000D-12 ,0.30D0 ,0.0D0 &
     &                     ,temperature ,adcol)
!
!....           HNO4 = HO2 + NO2
!
      rcarr(67,:) = sktroe(  9.050D-05 ,3.4D0 &
     &                     , 1.900D+15 ,0.30D0 ,10900.0D+00 &
     &                     ,temperature ,adcol)
!
!....           HNO4 + OH = H2O + NO2 + O2
!
      rcarr(68,:) = skarr(  4.500D-13 ,-610.0D+00 ,temperature)
!
!....           HO2 + NO3 = NO2 + O2 + OH
!
      rcarr(69,:) = skarr(  3.500D-12 ,0.0D+00 ,temperature)
!
!....           NO + NO3 = 2 NO2
!
      rcarr(70,:) = skarr(  1.700D-11 ,-125.0D+00 ,temperature)
!
!....           NO3 + OH = HO2 + NO2
!
      rcarr(71,:) = skarr(  2.000D-11 ,0.0D+00 ,temperature)
!
!....           NO2 + NO3 = N2O5
!
      rcarr(72,:) = sktroe(  2.400D-30 ,3.00D0 & 
     &                     , 1.600D-12 ,-0.10D0 ,0.0D0 &
     &                     ,temperature ,adcol)
!
!....           N2O5 = NO2 + NO3
!
      rcarr(73,:) = sktroe(  4.140D-04 ,3.0D0 &
     &                     , 2.760D+14 ,-0.10D0 ,10840.0D+00 &
     &                     ,temperature ,adcol)
!
!....           HCOOH + OH = H2O + HO2
!
      rcarr(74,:) = skarr(  4.000D-13 ,0.0D+00 ,temperature)
!
!....           MOH + OH = CH2O + HO2
!
      rcarr(75,:) = skarr(  2.900D-12 ,345.0D+00 ,temperature)
!
!....           NO2 + NO3 = NO + NO2 + O2
!
      rcarr(76,:) = skarr(  4.350D-14 ,1335.0D+00 ,temperature)
!
!....           CH2O + NO3 = CO + HNO3 + HO2
!
      rcarr(77,:) = skarr(  5.800D-16 ,0.0D+00 ,temperature)
!
!....           Cl + O3 = ClO + O2
!
      rcarr(78,:) = skarr(  2.300D-11 ,200.0D+00 ,temperature)
!
!....           Cl + H2 = H + HCl
!
      rcarr(79,:) = skarr(  3.050D-11 ,2270.0D+00 ,temperature)
!
!....           Cl + H2O2 = HCl + HO2
!
      rcarr(80,:) = skarr(  1.100D-11 ,980.0D+00 ,temperature)
!
!....           Cl + HO2 = HCl + O2
!
      rcarr(81,:) = skarr(  1.400D-11 ,-270.0D+00 ,temperature)
!
!....           Cl + HO2 = ClO + OH
!
      rcarr(82,:) = skarr(  3.600D-11 ,375.0D+00 ,temperature)
!
!....           ClO + O = Cl + O2
!
      rcarr(83,:) = skarr(  2.800D-11 ,-85.0D+00 ,temperature)
!
!....           ClO + OH = Cl + HO2
!
      rcarr(84,:) = skarr(  7.400D-12 ,-270.0D+00 ,temperature)
!
!....           ClO + OH = HCl + O2
!
      rcarr(85,:) = skarr(  6.000D-13 ,-230.0D+00 ,temperature)
!
!....           ClO + HO2 = HOCl + O2
!
      rcarr(86,:) = skarr(  2.600D-12 ,-290.0D+00 ,temperature)
!
!....           ClO + NO = Cl + NO2
!
      rcarr(87,:) = skarr(  6.400D-12 ,-290.0D+00 ,temperature)
!
!....           ClO + NO2 = ClONO2
!
      rcarr(88,:) = sktroe(  1.800D-31 ,3.40D0 & 
     &                     , 1.500D-11 ,1.90D0 ,0.0D0 &
     &                     ,temperature ,adcol)
!
!....           ClO + ClO = 2 Cl + O2
!
      rcarr(89,:) = skarr(  3.000D-11 ,2450.0D+00 ,temperature)
!
!....           ClO + ClO = Cl2 + O2
!
      rcarr(90,:) = skarr(  1.000D-12 ,1590.0D+00 ,temperature)
!
!....           ClO + ClO = Cl + OClO
!
      rcarr(91,:) = skarr(  3.500D-13 ,1370.0D+00 ,temperature)
!
!....           ClO + ClO = Cl2O2
!
      rcarr(92,:) = sktroe(  1.900D-32 ,3.60D0 & 
     &                     , 3.700D-12 ,1.60D0 ,0.0D0 &
     &                     ,temperature ,adcol)
!
!....           Cl2O2 = 2 ClO
!
      rcarr(93,:) = sktroe(  8.800D-06 ,3.6D0 &
     &                     , 1.710D+15 ,1.60D0 ,8537.0D+00 &
     &                     ,temperature ,adcol)
!
!....           HCl + OH = Cl + H2O
!
      rcarr(94,:) = skarr(  1.800D-12 ,250.0D+00 ,temperature)
!
!....           HOCl + OH = ClO + H2O
!
      rcarr(95,:) = skarr(  3.000D-12 ,500.0D+00 ,temperature)
!
!....           ClONO2 + O = ClO + NO3
!
      rcarr(96,:) = skarr(  3.600D-12 ,840.0D+00 ,temperature)
!
!....           ClONO2 + OH = HOCl + NO3
!
      rcarr(97,:) = skarr(  1.200D-12 ,330.0D+00 ,temperature)
!
!....           Cl + ClONO2 = Cl2 + NO3
!
      rcarr(98,:) = skarr(  6.500D-12 ,-135.0D+00 ,temperature)
!
!....           Br + O3 = BrO + O2
!
      rcarr(99,:) = skarr(  1.600D-11 ,780.0D+00 ,temperature)
!
!....           Br + HO2 = HBr + O2
!
      rcarr(100,:) = skarr(  4.800D-12 ,310.0D+00 ,temperature)
!
!....           Br + CH2O = CO + HBr + HO2
!
      rcarr(101,:) = skarr(  1.700D-11 ,800.0D+00 ,temperature)
!
!....           BrO + O = Br + O2
!
      rcarr(102,:) = skarr(  1.900D-11 ,-230.0D+00 ,temperature)
!
!....           BrO + HO2 = HOBr + O2
!
      rcarr(103,:) = skarr(  4.500D-12 ,-460.0D+00 ,temperature)
!
!....           BrO + NO = Br + NO2
!
      rcarr(104,:) = skarr(  8.800D-12 ,-260.0D+00 ,temperature)
!
!....           BrO + NO2 = BrONO2
!
      rcarr(105,:) = sktroe(  5.500D-31 ,3.10D0 & 
     &                     , 6.600D-12 ,2.90D0 ,0.0D0 &
     &                     ,temperature ,adcol)
!
!....           BrO + ClO = Br + OClO
!
      rcarr(106,:) = skarr(  9.500D-13 ,-550.0D+00 ,temperature)
!
!....           BrO + ClO = Br + Cl + O2
!
      rcarr(107,:) = skarr(  2.300D-12 ,-260.0D+00 ,temperature)
!
!....           BrO + ClO = BrCl + O2
!
      rcarr(108,:) = skarr(  4.100D-13 ,-290.0D+00 ,temperature)
!
!....           BrO + BrO = 2 Br + O2
!
      rcarr(109,:) = skbrodis (temperature)
!
!....           HBr + OH = Br + H2O
!
      rcarr(110,:) = skarr(  5.500D-12 ,-200.0D+00 ,temperature)
!
!....           CHBr3 + OH = 3 Br
!
      rcarr(111,:) = skarr(  9.000D-13 ,360.0D+00 ,temperature)
!
!....           CH2Br2 + OH = 2 Br
!
      rcarr(112,:) = skarr(  2.000D-12 ,840.0D+00 ,temperature)
!
!....           CH2O + O = CO + HO2 + OH
!
      rcarr(113,:) = skarr(  3.400D-11 ,1600.0D+00 ,temperature)
!
!....           CH4 + Cl = HCl + MO2
!
      rcarr(114,:) = skarr(  7.100D-12 ,1270.0D+00 ,temperature)
!
!....           CH2O + Cl = CO + HCl + HO2
!
      rcarr(115,:) = skarr(  8.100D-11 ,30.0D+00 ,temperature)
!
!....           CH3Cl + OH = Cl + H2O + HO2
!
      rcarr(116,:) = skarr(  1.960D-12 ,1200.0D+00 ,temperature)
!
!....           CH3CCl3 + OH = 3 Cl + H2O
!
      rcarr(117,:) = skarr(  1.640D-12 ,1520.0D+00 ,temperature)
!
!....           HCFC22 + OH = Cl + H2O
!
      rcarr(118,:) = skarr(  9.200D-13 ,1560.0D+00 ,temperature)
!
!....           HCFC141b + OH = 2 Cl + H2O
!
      rcarr(119,:) = skarr(  1.250D-12 ,1600.0D+00 ,temperature)
!
!....           HCFC142b + OH = Cl + H2O
!
      rcarr(120,:) = skarr(  1.300D-12 ,1770.0D+00 ,temperature)
!
!....           CH3Cl + Cl = CO + 2 HCl + HO2
!
      rcarr(121,:) = skarr(  2.030D-11 ,1110.0D+00 ,temperature)
!
!....           CH3Br + OH = Br + H2O + HO2
!
      rcarr(122,:) = skarr(  1.420D-12 ,1150.0D+00 ,temperature)
!
!....           CHCl3 + OH = 3 Cl
!
      rcarr(123,:) = skarr(  2.200D-12 ,920.0D+00 ,temperature)
!
!....           CH2Cl2 + OH = 2 Cl
!
      rcarr(124,:) = skarr(  1.920D-12 ,880.0D+00 ,temperature)
!
!....           C2H4Cl2 + OH = 2 Cl
!
      rcarr(125,:) = skarr(  1.140D-11 ,1150.0D+00 ,temperature)
!
!....           CHCl3 + Cl = 3 Cl + HCl
!
      rcarr(126,:) = skarr(  3.300D-12 ,990.0D+00 ,temperature)
!
!....           CH2Cl2 + Cl = 2 Cl + HCl
!
      rcarr(127,:) = skarr(  7.400D-12 ,910.0D+00 ,temperature)
!
!....           C2Cl4 + Cl = 2 Cl
!
      rcarr(128,:) = sktroe(  1.500D-28 ,8.50D0 & 
     &                     , 4.000D-11 ,1.20D0 ,0.0D0 &
     &                     ,temperature ,adcol)
!
!....           A3O2 + HO2 = RA3P
!
      rcarr(129,:) = ska3o2_ho2 (temperature)
!
!....           A3O2 + MO2 =  0.75 CH2O + HO2 +  0.25 MOH +  0.75 RCHO +  0.25 ROH
!
      rcarr(130,:) = skarr(  5.920D-13 ,0.0D+00 ,temperature)
!
!....           A3O2 + NO = HO2 + NO2 + RCHO
!
      rcarr(131,:) = ska3o2_no_b (temperature ,adcol)
!
!....           ACET + OH = ATO2 + H2O
!
      rcarr(132,:) = skacetoh (temperature)
!
!....           ACTA + OH = H2O + MO2
!
      rcarr(133,:) = skarr(  3.150D-14 ,-920.0D+00 ,temperature)
!
!....           ALD2 + NO3 = HNO3 + MCO3
!
      rcarr(134,:) = skarr(  1.400D-12 ,1900.0D+00 ,temperature)
!
!....           ALD2 + OH =  0.05 CH2O +  0.05 CO + H2O +  0.05 HO2 +  0.95 MCO3
!
      rcarr(135,:) = skarr(  4.630D-12 ,-350.0D+00 ,temperature)
!
!....           ALK4 + NO3 = HNO3 + R4O2
!
      rcarr(136,:) = skarr(  2.800D-12 ,3280.0D+00 ,temperature)
!
!....           ALK4 + OH = R4O2
!
      rcarr(137,:) = skarr(  1.250D-11 ,415.0D+00 ,temperature)
!
!....           ATO2 + HO2 =  0.15 CH2O +  0.85 HCOOH +  0.15 MCO3 +  0.15 OH
!
      rcarr(138,:) = skarr(  8.600D-13 ,-700.0D+00 ,temperature)
!
!....           ATO2 + MCO3 =  0.10 ACTA +  0.90 CH2O +  0.90 MCO3 +  0.10 MGLY +  0.90 MO2
!
      rcarr(139,:) = skarr(  1.870D-12 ,-500.0D+00 ,temperature)
!
!....           ATO2 + MO2 =  0.50 CH2O +  0.20 HAC +  0.30 HO2 +  0.30 MCO3 +  0.50 MGLY +  0.50 MOH
!
      rcarr(140,:) = skarr(  7.500D-13 ,-500.0D+00 ,temperature)
!
!....           ATO2 + NO = CH2O + MCO3 + NO2
!
      rcarr(141,:) = skarr(  2.900D-12 ,-300.0D+00 ,temperature)
!
!....           B3O2 + HO2 = RB3P
!
      rcarr(142,:) = skb3o2_ho2 (temperature)
!
!....           B3O2 + MCO3 = ACET +  0.10 ACTA +  0.90 HO2 +  0.90 MO2
!
      rcarr(143,:) = skarr(  1.870D-13 ,-500.0D+00 ,temperature)
!
...
!
      rcarr(145,:) = skb3o2_no_b (temperature ,adcol)
!
!....           C2H6 + NO3 = ETO2 + HNO3
!
      rcarr(146,:) = skarr(  1.400D-18 ,0.0D+00 ,temperature)
!
!....           C2H6 + OH = ETO2 + H2O
!
      rcarr(147,:) = skarr(  7.660D-12 ,1020.0D+00 ,temperature)
!
!....           C2H6 + Cl = ETO2 + HCl
!
      rcarr(148,:) = skarr(  7.200D-11 ,70.0D+00 ,temperature)
!
!....           C3H8 + OH = A3O2
!
      rcarr(149,:) = skc3h8oh_1 (temperature)
!
!....           C3H8 + OH = B3O2
!
      rcarr(150,:) = skc3h8oh_2 (temperature)
!
!....           CH3CN + OH =  0.30 H +  0.30 HCN
!
      rcarr(151,:) = skarr(  7.800D-13 ,1050.0D+00 ,temperature)
!
!....           CH3CN + O1D =  0.30 H
!
      rcarr(152,:) = skarr(  2.540D-10 ,24.0D+00 ,temperature)
!
!....           CH3CN + Cl = HCl
!
      rcarr(153,:) = skarr(  1.600D-11 ,2140.0D+00 ,temperature)
!
!....           EOH + OH = ALD2 + HO2
!
      rcarr(154,:) = skarr(  3.350D-12 ,0.0D+00 ,temperature)
!
!....           ETO2 + ETO2 =  1.60 ALD2 +  0.40 EOH +  1.20 HO2
!
      rcarr(155,:) = skarr(  6.800D-14 ,0.0D+00 ,temperature)
!
!....           ETO2 + NO = ALD2 + HO2 + NO2
!
      rcarr(156,:) = sketo2_no_b (temperature ,adcol)
!
...
!
      rcarr(158,:) = skglyca_oh (temperature)
!
!....           GLYC + OH = CO + HCOOH + OH
!
      rcarr(159,:) = skglycb_oh (temperature)
!
!....           GLYX + NO3 = 2 CO + HNO3 + HO2
!
      rcarr(160,:) = skno3glyx (temperature ,oxygen)
!
!....           GLYX + OH = 2 CO + HO2
!
      rcarr(161,:) = skarr(  3.100D-12 ,-340.0D+00 ,temperature)
!
!....           HAC + OH = HO2 + MGLY
!
      rcarr(162,:) = skhaca_oh (temperature)
!
!....           HAC + OH =  0.50 ACTA +  0.50 CO +  0.50 HCOOH +  0.50 MO2 + OH
!
      rcarr(163,:) = skhacb_oh (temperature)
!
!....           HCN + O1D = CO + NO
!
      rcarr(164,:) = skarr(  1.080D-10 ,-105.0D+00 ,temperature)
!
!....           HCN + OH = H2O
!
      rcarr(165,:) = sktroe(  6.100D-33 ,1.50D0 & 
     &                     , 9.800D-15 ,-4.60D0 ,0.0D0 &
     &                     ,temperature ,adcol)
!
!....           ETO2 + HO2 = ETP
!
      rcarr(166,:) = skarr(  7.500D-13 ,-700.0D+00 ,temperature)
!
!....           HO2 + MCO3 =  0.13 ACTA +  0.37 MAP +  0.50 MO2 +  0.13 O3 +  0.50 OH
!
      rcarr(167,:) = skarr(  3.140D-12 ,-580.0D+00 ,temperature)
!
!....           IALD + OH =  0.15 HO2 +  0.44 IAO2 +  0.41 MAO3
!
      rcarr(168,:) = skarr(  1.170D-11 ,-450.0D+00 ,temperature)
!
!....           HO2 + IAO2 =  0.50 MACR +  0.50 MVK + 2 OH
!
      rcarr(169,:) = skarr(  2.380D-13 ,-1300.0D+00 ,temperature)
!
...
!....           HO2 + INO2 = INPN
!
      rcarr(171,:) = skarr(  2.470D-13 ,-1300.0D+00 ,temperature)
!
!....           INO2 + MCO3 =  0.15 CH2O +  0.85 HNO3 +  0.80 HO2 +  0.10 MACR + MO2 +  0.05 MVK +  0.15 NO2
!
      rcarr(172,:) = skarr(  7.710D-12 ,0.0D+00 ,temperature)
!
!....           INO2 + MCO3 = ACTA + NO2 + RCHO
!
      rcarr(173,:) = skarr(  1.920D-12 ,0.0D+00 ,temperature)
!
!....           INO2 + MO2 =  0.83 CH2O +  0.43 HNO3 +  0.90 HO2 +  0.05 MACR +  0.25 MOH +  0.03 MVK +  0.57 NO2 +  0.25 RCHO +  0.25 ROH
!
      rcarr(174,:) = skarr(  1.460D-12 ,0.0D+00 ,temperature)
!
!....           INO2 + NO =  0.15 CH2O +  0.85 HNO3 +  0.80 HO2 +  0.10 MACR +  0.05 MVK +  1.15 NO2
!
      rcarr(175,:) = skarr(  2.700D-12 ,-350.0D+00 ,temperature)
!
!....           INPN + OH = INO2
!
      rcarr(176,:) = skarr(  5.680D-12 ,-200.0D+00 ,temperature)
!
!....           ISOP + NO3 = INO2
!
      rcarr(177,:) = skarr(  2.950D-12 ,450.0D+00 ,temperature)
!
!....           ISOP + O3 =  0.83 CH2O +  0.41 CO +  0.01 H2O2 +  0.58 HCOOH +  0.16 HO2 +  0.42 MACR +  0.41 MO2 +  0.18 MVK +  0.28 OH
!
      rcarr(178,:) = skarr(  1.100D-14 ,2000.0D+00 ,temperature)
!
!....           ISOP + OH = RIO1
!
      rcarr(179,:) = skisop_oh_rio1 (temperature)
!
!....           ISOP + OH = RIO2
!
      rcarr(180,:) = skisop_oh_rio2 (temperature)
!
...
!
      rcarr(182,:) = skarr(  1.870D-13 ,-500.0D+00 ,temperature)
!
...
!
      rcarr(184,:) = skarr(  2.700D-12 ,-350.0D+00 ,temperature)
!
!....           MACR + NO3 =  0.68 CO +  0.32 HNO3 +  0.32 MAO3 +  0.68 MGLY +  0.68 NO2
!
      rcarr(185,:) = skarr(  1.800D-13 ,1190.0D+00 ,temperature)
!
!....           MACR + OH = MAO3
!
      rcarr(186,:) = skarr(  2.700D-12 ,-470.0D+00 ,temperature)
!
!....           MACR + O3 =  0.12 CH2O +  0.12 CO +  0.88 HCOOH +  0.12 MCO3 +  0.88 MGLY +  0.12 OH
!
      rcarr(187,:) = skarr(  1.500D-15 ,2110.0D+00 ,temperature)
!
!....           HO2 + MAO3 =  0.50 CH2O +  0.32 CO +  0.50 MAOP +  0.17 MCO3 +  0.32 MO2 +  0.13 O3 +  0.50 OH
!
      rcarr(188,:) = skarr(  3.140D-12 ,-580.0D+00 ,temperature)
!
!....           MAO3 + NO = CH2O +  0.65 CO +  0.35 MCO3 +  0.65 MO2 + NO2
!
      rcarr(189,:) = skarr(  8.700D-12 ,-290.0D+00 ,temperature)
!
!....           MAO3 + NO2 = PMN
!
      rcarr(190,:) = skmao3_no2 (temperature ,adcol)
!
!....           MAOP + OH =  0.25 CH2O +  0.49 CO +  0.49 HAC +  0.17 MAO3 +  0.10 MAOP +  0.09 MCO3 +  0.16 MO2 +  0.58 OH
!
      rcarr(191,:) = skarr(  1.660D-11 ,0.0D+00 ,temperature)
!
!....           A3O2 + MCO3 =  0.10 ACTA +  0.90 HO2 +  0.90 MO2 + RCHO
!
      rcarr(192,:) = skarr(  1.870D-12 ,-500.0D+00 ,temperature)
!
...
!....           MCO3 + MCO3 = 2 MO2
!
      rcarr(194,:) = skarr(  2.900D-12 ,-500.0D+00 ,temperature)
!
!....           MCO3 + MO2 =  0.10 ACTA + CH2O +  0.90 HO2 +  0.90 MO2
!
      rcarr(195,:) = skarr(  2.000D-13 ,-500.0D+00 ,temperature)
!
!....           MCO3 + NO2 = PAN
!
      rcarr(196,:) = sktroe(  7.300D-29 ,4.10D0 & 
     &                     , 9.500D-12 ,1.60D0 ,0.0D0 &
     &                     ,temperature ,adcol)
!
!....           MCO3 + NO = MO2 + NO2
!
      rcarr(197,:) = skarr(  8.100D-12 ,-270.0D+00 ,temperature)
!
!....           MCO3 + PO2 =  0.10 ACTA +  0.90 ALD2 +  0.90 CH2O +  0.06 HAC +  0.90 HO2 +  0.90 MO2 +  0.04 RCHO
!
      rcarr(198,:) = skarr(  1.870D-12 ,-500.0D+00 ,temperature)
!
!....           MEK + NO3 = HNO3 + KO2
!
      rcarr(199,:) = skarr(  8.000D-16 ,0.0D+00 ,temperature)
!
!....           MEK + OH = H2O + KO2
!
      rcarr(200,:) = skohmek (temperature)
!
!....           MGLY + NO3 = CO + HNO3 + MCO3
!
      rcarr(201,:) = skarr(  3.360D-12 ,1860.0D+00 ,temperature)
!
!....           MGLY + OH = CO + MCO3
!
      rcarr(202,:) = skarr(  1.900D-12 ,-575.0D+00 ,temperature)
!
!....           MVK + O3 =  0.04 ALD2 +  0.80 CH2O +  0.05 CO +  0.06 HO2 +  0.82 MGLY +  0.20 O3 +  0.08 OH
!
      rcarr(203,:) = skarr(  8.500D-16 ,1520.0D+00 ,temperature)
!
!....           MVK + OH = VRO2
!
      rcarr(204,:) = skarr(  2.700D-12 ,-580.0D+00 ,temperature)
!
!....           MAP + OH =  0.22 CH2O +  0.78 MCO3 +  0.22 OH
!
      rcarr(205,:) = skarr(  3.000D-14 ,0.0D+00 ,temperature)
!
!....           OH + RCHO = H2O + RCO3
!
      rcarr(206,:) = skarr(  6.000D-12 ,-410.0D+00 ,temperature)
!
!....           OH + RCOOH = ETO2
!
      rcarr(207,:) = skarr(  1.200D-12 ,0.0D+00 ,temperature)
!
!....           PAN = MCO3 + NO2
!
      rcarr(208,:) = skpanan (temperature,adcol)
!
!....           PMN = MAO3 + NO2
!
      rcarr(209,:) = skarr(  1.600D+16 ,13500.0D+00 ,temperature)
!
!....           OH + PMN =  0.25 CO +  0.25 HAC +  0.75 MAOP + NO3
!
      rcarr(210,:) = skarr(  2.900D-11 ,0.0D+00 ,temperature)
!
!....           HO2 + PO2 = PP
!
      rcarr(211,:) = ska3o2_ho2 (temperature)
!
!....           MO2 + PO2 =  0.50 ALD2 +  1.25 CH2O +  0.16 HAC + HO2 +  0.25 MOH +  0.09 RCHO +  0.25 ROH
!
      rcarr(212,:) = skarr(  5.920D-13 ,0.0D+00 ,temperature)
!
!....           NO + PO2 = ALD2 + CH2O + HO2 + NO2
!
      rcarr(213,:) = skarr(  2.700D-12 ,-350.0D+00 ,temperature)
!
!....           PPN = NO2 + RCO3
!
      rcarr(214,:) = skppndecomp (temperature,adcol)
!
!....           OH + PP =  0.79 HAC +  0.79 OH +  0.21 PO2
!
      rcarr(215,:) = skarr(  8.780D-12 ,-200.0D+00 ,temperature)
!
!....           HO2 + PRN1 = PRPN
!
      rcarr(216,:) = ska3o2_ho2 (temperature)
!
...
!
      rcarr(218,:) = skarr(  8.370D-14 ,0.0D+00 ,temperature)
!
!....           NO + PRN1 = ALD2 + CH2O + 2 NO2
!
      rcarr(219,:) = skarr(  2.700D-12 ,-350.0D+00 ,temperature)
!
!....           NO3 + PRPE = PRN1
!
      rcarr(220,:) = skarr(  4.590D-13 ,1156.0D+00 ,temperature)
!
!....           O3 + PRPE =  0.12 ACTA +  0.50 ALD2 +  0.50 CH2O +  0.10 CH4 +  0.56 CO +  0.22 HCOOH +  0.28 HO2 +  0.28 MO2 +  0.36 OH
!
      rcarr(221,:) = skarr(  6.500D-15 ,1900.0D+00 ,temperature)
!
!....           OH + PRPE = PO2
!
      rcarr(222,:) = sktroe(  4.700D-27 ,4.00D0 & 
     &                     , 2.600D-11 ,1.30D0 ,0.0D0 &
     &                     ,temperature ,adcol)
!
!....           OH + PRPN =  0.79 MGLY +  0.79 NO2 +  0.21 PRN1
!
      rcarr(223,:) = skarr(  8.780D-12 ,-200.0D+00 ,temperature)
!
!....           HO2 + R4N1 = R4N2
!
      rcarr(224,:) = skarr(  7.400D-13 ,-700.0D+00 ,temperature)
!
!....           MCO3 + R4N1 =  0.10 ACTA +  0.68 ALD2 +  0.35 CH2O +  0.90 MO2 + NO2 +  0.27 R4O2 +  0.61 RCHO
!
      rcarr(225,:) = skarr(  1.870D-12 ,-500.0D+00 ,temperature)
!
...
!
      rcarr(227,:) = skarr(  2.700D-12 ,-350.0D+00 ,temperature)
!
!....           OH + R4N2 = H2O + R4N1
!
      rcarr(228,:) = skarr(  1.600D-12 ,0.0D+00 ,temperature)
!
!....           HO2 + R4O2 = R4P
!
      rcarr(229,:) = skarr(  7.400D-13 ,-700.0D+00 ,temperature)
!
!....           MCO3 + R4O2 =  0.05 A3O2 +  0.29 ACET +  0.10 ACTA +  0.29 ALD2 +  0.16 B3O2 +  0.29 ETO2 +  0.24 HO2 +  0.27 MEK +  0.90 MO2 +  0.25 RCHO
!
      rcarr(230,:) = skarr(  1.870D-12 ,-500.0D+00 ,temperature)
!
...
!
      rcarr(231,:) = skarr(  8.370D-14 ,0.0D+00 ,temperature)
!
!....           NO + R4O2 =  0.05 A3O2 +  0.34 ACET +  0.34 ALD2 +  0.19 B3O2 +  0.34 ETO2 +  0.27 HO2 +  0.19 MEK +  0.19 MO2 + NO2 +  0.15 RCHO
!
      rcarr(232,:) = skr4o2_no_b (temperature ,adcol)
!
!....           NO + R4O2 = R4N2
!
      rcarr(233,:) = skr4o2_no_a (temperature ,adcol)
!
...
!
      rcarr(235,:) = skarr(  5.180D-12 ,-200.0D+00 ,temperature)
!
!....           OH + RB3P =  0.79 ACET +  0.21 B3O2 +  0.79 OH
!
      rcarr(236,:) = skarr(  8.780D-12 ,-200.0D+00 ,temperature)
!
!....           NO3 + RCHO = HNO3 + RCO3
!
      rcarr(237,:) = skarr(  6.500D-15 ,0.0D+00 ,temperature)
!
!....           HO2 + RCO3 =  0.03 A3O2 +  0.12 B3O2 +  0.22 ETO2 +  0.15 O3 +  0.44 OH +  0.15 RCOOH +  0.41 RP
!
      rcarr(238,:) = skarr(  4.300D-13 ,-1040.0D+00 ,temperature)
!
!....           MCO3 + RCO3 =  0.07 A3O2 +  0.27 B3O2 +  0.49 ETO2 + MO2
!
      rcarr(239,:) = skarr(  2.500D-12 ,-500.0D+00 ,temperature)
!
!....           MO2 + RCO3 =  0.07 A3O2 +  0.27 B3O2 + CH2O +  0.49 ETO2 + HO2
!
      rcarr(240,:) = skarr(  1.870D-12 ,-500.0D+00 ,temperature)
!
!....           NO2 + RCO3 = PPN
!
      rcarr(241,:) = sktroe(  9.000D-28 ,8.90D0 & 
     &                     , 7.700D-12 ,0.20D0 ,0.0D0 &
     &                     ,temperature ,adcol)
!
!....           NO + RCO3 =  0.07 A3O2 +  0.27 B3O2 +  0.49 ETO2 + NO2
!
      rcarr(242,:) = skarr(  6.700D-12 ,-340.0D+00 ,temperature)
!
!....           HO2 + RIO1 =  0.06 CH2O +  0.06 HO2 +  0.06 MVK +  0.06 OH +  0.94 RIPA
!
      rcarr(243,:) = skarr(  2.120D-13 ,-1300.0D+00 ,temperature)
!
!....           HO2 + RIO2 =  0.06 CH2O +  0.06 HO2 +  0.06 MACR +  0.06 OH +  0.94 RIPB
!
      rcarr(244,:) = skarr(  2.120D-13 ,-1300.0D+00 ,temperature)
!
!....           MO2 + RIO1 = 2 CH2O + 2 HO2 + MVK
!
      rcarr(245,:) = skarr(  2.000D-12 ,0.0D+00 ,temperature)
!
!....           MO2 + RIO2 = 2 CH2O + 2 HO2 + MACR
!
      rcarr(246,:) = skarr(  2.000D-12 ,0.0D+00 ,temperature)
!
!....           RIO1 + RIO1 = 2 CH2O + 2 HO2 + 2 MVK
!
      rcarr(247,:) = skarr(  6.920D-14 ,0.0D+00 ,temperature)
!
!....           RIO2 + RIO2 = 2 CH2O + 2 HO2 + 2 MACR
!
      rcarr(248,:) = skarr(  5.740D-12 ,0.0D+00 ,temperature)
!
!....           RIO1 + RIO2 = 2 CH2O + 2 HO2 + MACR + MVK
!
      rcarr(249,:) = skarr(  1.540D-12 ,0.0D+00 ,temperature)
!
!....           NO + RIO1 = CH2O + HO2 + MVK + NO2
!
      rcarr(250,:) = skrio1_no (temperature ,adcol)
!
!....           NO + RIO2 = CH2O + HO2 + MACR + NO2
!
      rcarr(251,:) = skrio2_no (temperature ,adcol)
!
!....           NO + RIO1 = HNO3
!
      rcarr(252,:) = skrio1_no_hno3 (temperature ,adcol)
!
!....           NO + RIO2 = HNO3
!
      rcarr(253,:) = skro2noadd_2 (temperature ,adcol)
!
!....           RIO1 = CH2O + MVK + OH
!
      rcarr(254,:) = skrio1 (temperature)
!
!....           RIO2 = CH2O + MACR + OH
!
      rcarr(255,:) = skrio2 (temperature)
!
!....           RIO1 =  0.30 CH2O +  0.60 CO +  0.40 HO2 +  0.40 IALD +  0.30 MCO3 +  0.30 MGLY +  1.50 OH
!
      rcarr(256,:) = skrio1_2 (temperature)
!
!....           RIO2 =  0.30 CH2O +  0.90 CO +  0.30 HCOOH +  0.70 HO2 +  0.40 IALD +  0.30 MGLY +  1.50 OH
!
      rcarr(257,:) = skrio2_2 (temperature)
!
!....           OH + RIPA =  0.25 CO +  0.25 HO2 +  0.12 MRP +  0.12 MVK +  0.75 RIO1
!
      rcarr(258,:) = skarr(  6.100D-12 ,-200.0D+00 ,temperature)
!
!....           OH + RIPB =  0.33 CO +  0.33 HO2 +  0.16 IAO2 +  0.17 MACR +  0.17 MRP +  0.51 RIO2
!
      rcarr(259,:) = skarr(  4.100D-12 ,-200.0D+00 ,temperature)
!
!....           OH + ROH = HO2 + RCHO
!
      rcarr(260,:) = skarr(  3.350D-12 ,0.0D+00 ,temperature)
!
!....           OH + RP =  0.50 ALD2 +  0.50 OH +  0.50 RCO3
!
      rcarr(261,:) = skarr(  6.130D-13 ,-200.0D+00 ,temperature)
!
!....           HO2 + VRO2 =  0.05 CH2O +  0.36 GLYC +  0.31 HO2 +  0.25 MAOP +  0.36 MCO3 +  0.05 MGLY +  0.67 OH +  0.34 VRP
!
      rcarr(262,:) = skarr(  2.120D-13 ,-1300.0D+00 ,temperature)
!
!....           NO + VRO2 = HNO3
!
      rcarr(263,:) = skro2noadd_3 (temperature ,adcol)
!
!....           NO + VRO2 =  0.24 CH2O +  0.76 GLYC +  0.24 HO2 +  0.76 MCO3 +  0.24 MGLY + NO2
!
      rcarr(264,:) = skvro2_no (temperature ,adcol)
!
!....           OH + VRP =  1.19 CO +  0.53 HO2 +  0.53 MCO3 +  0.19 MGLY +  0.19 OH
!
      rcarr(265,:) = skarr(  2.000D-12 ,-70.0D+00 ,temperature)
!
!....           N2O5 = 2 HNO3
!
...
!
      rcarr(266,:) = sklbs_n2o5 (temperature ,pressure ,sad_lbs ,wt_h2so4 ,ptrop)
!
!....           ClONO2 = HNO3 + HOCl
!
      rcarr(267,:) = sklbs_clono2_h2o (temperature  & 
     &           ,pressure ,sad_lbs ,g_clono2_h2o ,mw(iCLONO2) ,ptrop)
!
!....           BrONO2 = HNO3 + HOBr
!
      rcarr(268,:) = sklbs_brono2 (temperature ,pressure ,sad_lbs ,wt_h2so4 ,ptrop)
!
!....           ClONO2 + HCl = Cl2 + HNO3
!
      rcarr(269,:) = sklbs_clono2_hcl (temperature  & 
     &           ,pressure ,sad_lbs ,g_clono2_hcl ,mw(iCLONO2) ,specarr( 56,:) ,ptrop)
!
!....           HCl + HOCl = Cl2 + H2O
!
      rcarr(270,:) = sklbs_hocl_hcl (temperature  & 
     &           ,pressure ,sad_lbs ,g_hocl_hcl ,mw(iHOCL) ,specarr( 56,:) ,ptrop)
!
!....           HCl + HOBr = BrCl + H2O
!
      rcarr(271,:) = sklbs_hobr_hcl (temperature  & 
     &           ,adcol ,pressure ,sad_lbs ,specarr(  63,:) ,specarr( 56,:) ,water  & 
     &           ,ptrop)
!
!....           N2O5 = 2 HNO3
!
      rcarr(272,:) = sksts_n2o5 (temperature ,pressure ,sad_sts ,ptrop)
!
!....           ClONO2 = HNO3 + HOCl
!
      rcarr(273,:) = sksts_clono2 (temperature  & 
     &           ,adcol ,pressure ,sad_sts ,specarr(  56,:) ,water ,ptrop)
!
!....           BrONO2 = HNO3 + HOBr
!
      rcarr(274,:) = sksts_brono2 (temperature ,pressure ,sad_sts ,ptrop)
!
!....           ClONO2 + HCl = Cl2 + HNO3
!
      rcarr(275,:) = sksts_clono2_hcl (temperature  & 
     &           ,adcol ,pressure ,sad_sts ,specarr(    38,:) ,specarr(  56,:) ,water  & 
     &           ,ptrop)
!
!....           HCl + HOCl = Cl2 + H2O
!
      rcarr(276,:) = sksts_hocl_hcl (temperature  & 
     &           ,adcol ,pressure ,sad_sts ,specarr(  64,:) ,specarr( 56,:) ,water  & 
     &           ,ptrop)
!
!....           HCl + HOBr = BrCl + H2O
!
      rcarr(277,:) = sksts_hobr_hcl (temperature  & 
     &           ,adcol ,pressure ,sad_sts ,specarr(  63,:) ,specarr( 56,:) ,water  & 
     &           ,ptrop)
!
!....           ClONO2 = HNO3 + HOCl
!
      rcarr(278,:) = sknat_clono2 (temperature ,pressure ,sad_nat ,ptrop)
!
!....           BrONO2 = HNO3 + HOBr
!
      rcarr(279,:) = sknat_brono2 (temperature ,pressure ,sad_nat ,ptrop)
!
!....           ClONO2 + HCl = Cl2 + HNO3
!
      rcarr(280,:) = sknat_hcl_clono2 (temperature  & 
     &           ,pressure ,sad_nat ,specarr(  56,:) ,ptrop)
!
!....           HCl + HOCl = Cl2 + H2O
!
      rcarr(281,:) = sknat_hcl_hocl (temperature  & 
     &           ,pressure ,sad_nat ,specarr(  56,:) ,ptrop)
!
!....           BrONO2 + HCl = BrCl + HNO3
!
      rcarr(282,:) = sknat_hcl_brono2 (temperature  & 
     &           ,pressure ,sad_nat ,specarr(  56,:) ,ptrop)
!
!....           HCl + HOBr = BrCl + H2O
!
      rcarr(283,:) = sknat_hcl_hobr (temperature  & 
     &           ,pressure ,sad_nat ,specarr(  56,:) ,ptrop)
!
!....           ClONO2 = HNO3 + HOCl
!
      rcarr(284,:) = skice_clono2 (temperature ,pressure ,sad_ice ,ptrop)
!
!....           BrONO2 = HNO3 + HOBr
!
      rcarr(285,:) = skice_brono2 (temperature ,pressure ,sad_ice ,ptrop)
!
!....           ClONO2 + HCl = Cl2 + HNO3
!
      rcarr(286,:) = skice_hcl_clono2 (temperature  & 
     &           ,pressure ,sad_ice ,specarr(  56,:) ,ptrop)
!
!....           HCl + HOCl = Cl2 + H2O
!
      rcarr(287,:) = skice_hcl_hocl (temperature  & 
     &           ,pressure ,sad_ice ,specarr(  56,:) ,ptrop)
!
!....           BrONO2 + HCl = BrCl + HNO3
!
      rcarr(288,:) = skice_hcl_brono2 (temperature  & 
     &           ,pressure ,sad_ice ,specarr(  56,:) ,ptrop)
!
!....           HCl + HOBr = BrCl + H2O
!
      rcarr(289,:) = skice_hcl_hobr (temperature  & 
     &           ,pressure ,sad_ice ,specarr(  56,:) ,ptrop)
!
!....           HNO3 = NO2 + OH
!
      rcarr(290,:) = skpyro_hno3 (temperature ,sad_pyro)
!
!....           NO3 + NO3 = 2 NO2 + O2
!
      rcarr(291,:) = skarr(  8.500D-13 ,2450.0D+00 ,temperature)
!
!....           HO2 =  0.50 H2O
!
      rcarr(292,:) = sktrs_ho2 (temperature, & 
     &            sadcol2, adcol, radA, NSADaer, NSADdust, cPBLcol, pressure)
!
!....           NO2 =  0.50 HNO2 +  0.50 HNO3
!
      rcarr(293,:) = sktrs_no2 (temperature, & 
     &            sadcol2, adcol, radA, NSADaer,NSADdust,ptrop, pressure)
!
!....           NO3 = HNO3
!
      rcarr(294,:) = sktrs_no3 (temperature, & 
     &            sadcol2, adcol, radA,NSADaer,NSADdust,ptrop, pressure)
!
!....           N2O5 = 2 HNO3
!
      rcarr(295,:) = sktrs_n2o5 (temperature, & 
     &           sadcol2,adcol,radA,FRH,NSADaer,NSADdust, ptrop, pressure)
!
!....           DMS + OH = SO2
!
      rcarr(296,:) = skoh_dms (temperature, oxygen, adcol)
!
!....           DMS + NO3 = HNO3 + SO2
!
      rcarr(297,:) = skarr(  1.900D-13 ,-530.0D+00 ,temperature)
!
!....           O + SO2 = H2SO4
!
      rcarr(298,:) = sktroe(  1.800D-33 ,-2.00D0 & 
     &                     , 4.200D-14 ,-1.80D0 ,0.0D0 &
     &                     ,temperature ,adcol)
!
!....           OH + SO2 = H2SO4
!
      rcarr(299,:) = sktroe(  2.900D-31 ,4.10D0 & 
     &                     , 1.700D-12 ,-0.20D0 ,0.0D0 &
     &                     ,temperature ,adcol)
!
!....           H2O2 + SO2 = H2SO4
!
      rcarr(300,:) = skso2h2o2 (temperature, pressure, lwc, fcld)
!
!....           O3 + SO2 = H2SO4
!
      rcarr(301,:) = skarr(  3.000D-12 ,7000.0D+00 ,temperature)
!
!....           O + OCSg = CO + SO2
!
      rcarr(302,:) = skarr(  2.100D-11 ,2200.0D+00 ,temperature)
!
!....           OCSg + OH = SO2
!
      rcarr(303,:) = skarr(  7.200D-14 ,1070.0D+00 ,temperature)
!
...
!
!.... skoo (temperature ,adcol)
! _1_
!
!.... Legacy - personal communication, Eric Fleming (3/4/26)
!
        FUNCTION skoo (tk,ad)
!
!....      O + O = O2
!
          real*8  tk(:) ,ad(:)
          real*8, DIMENSION(size(tk)) :: skoo
!
          skoo(:) = 1.4D-33 * exp(-408.0d0 / tk(:)) * ad(:)
!
        END FUNCTION skoo
!
...
!
!.... skisop_oh_rio1 (temperature)
! _1_
!
!.... Harvard/GMI from GEOSCHEM 14.7.0
!
      FUNCTION skisop_oh_rio1 (tk)
!
! Used to compute the rate for this reaction:
!    ISOP + OH = RIO1
!
      ...
      REAL*8, DIMENSION(size(tk)) :: k0, k1, k2, skisop_oh_rio1
!
!  FUNCTION GC_ISO1(1.7E-11, 390.0, 9.33E-2, 5.05E15, &
!                   -12200.0, 1.79E14, -8830.0)
!
      a0 =      1.7d-11
      b0 =    390.0d+0
      c0 =     9.33d-2
...
!
      ...
      k1(:) = f0*EXP(g0/tk(:))
      k2(:) = c0*k0(:)/(k0(:)+k1(:))
      skisop_oh_rio1(:) = a0 * EXP(b0/tk(:)) * (1.0d0-k2(:))
      END FUNCTION skisop_oh_rio1
!
